...
#Set path signal threshold. Add this to settings later.
PATH_SS_THRESHOLD = 3
...
class MainWindow(QMainWindow):
    ...
    def generateRelayPaths(self):
        ...
        #Get all callsigns that are currently in the Signals table. These are the contactable stations. Excludes stations with a signal below the SS Threashold
